let dados = [
    {
        titulo : "Ayrton Senna da Silva",
        descricao : "Senna era conhecido por sua habilidade excepcional ao volante, determinação e paixão pelas corridas. Seu estilo de pilotagem agressivo e preciso o tornou um dos maiores ídolos do automobilismo mundial. Tragicamente, faleceu durante o Grande Prêmio de San Marino de 1994, deixando um legado que o imortalizou no esporte.",
        titulos : "1988: Sua primeira conquista veio ao volante da McLaren-Honda, um carro dominador daquela temporada. Senna mostrou um desempenho excepcional, combinando velocidade com consistência. 1990: Em uma temporada marcada pela rivalidade com Alain Prost, Senna conseguiu superar o francês e conquistar seu segundo título mundial.1991: Em seu ano mais dominante, Senna conquistou seu terceiro título mundial com quatro vitórias nas primeiras quatro corridas.",
        link : "https://senna.com/",
    },
    {
        titulo: "Nelson Piquet",
        descricao: "Três vezes campeão mundial de Fórmula 1, Nelson Piquet era conhecido por sua inteligência e habilidade técnica. Seu estilo de pilotagem era caracterizado pela precisão e pela capacidade de extrair o máximo do carro.",
        titulos: "1981, 1983 e 1987: Conquistou seus títulos mundiais pilotando por equipes como Brabham e Williams.",
        link: "https://pt.wikipedia.org/wiki/Nelson_Piquet"
    },
    {
        titulo: "Emerson Fittipaldi",
        descricao: "O primeiro brasileiro a conquistar o título mundial de Fórmula 1, em 1972. Fittipaldi era um piloto completo, com grande habilidade e versatilidade. Além da Fórmula 1, conquistou títulos na Indy 500 e nas 24 Horas de Le Mans.",
        titulos: "1972 e 1974: Conquistou seus títulos mundiais pilotando pela Lotus.",
